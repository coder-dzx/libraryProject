        ...
        <div class="col-md-10">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                ...
                                <li>可查询图书的编号、类型、名称、作者、总数、馆藏地等</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>可查询除图书的基本信息、借阅日期、截止还书日期、是否逾期等</li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">预约信息</div>
                        </div>
                        <div class="bootstrap-admin-panel-content">
                            <ul>
                                <li>根据图书编号、类型、名称、作者、总数、馆藏地任意条件进行模糊查询预约的图书信息</li>
                                <li>查询自己的预约信息。如有特殊情况，可以自行取消预约。</li>
                            </ul>
                        </div>
                    </div>
                </div>
