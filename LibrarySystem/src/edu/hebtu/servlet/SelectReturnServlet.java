 ...
 * @date 2019/6/1 - 13:10
 */
@WebServlet("/selectReturnServlet")
public class SelectReturnServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        PageBean<History> pb=service.returnpageQuery(currentPage,pageSize,username);
